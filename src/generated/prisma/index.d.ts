...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Checkout: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.CheckoutFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.CheckoutAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type ProductOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "image" | "category" | "description" | "link" | "price" | "size", ExtArgs["result"]["product"]>
  ...
  export type CheckoutOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "phone" | "email" | "address" | "districts" | "area" | "postalcode" | "products" | "Payment" | "status" | "createdAt" | "updatedAt", ExtArgs["result"]["checkout"]>
  ...
  export interface CheckoutDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Checkouts that matches the filter.
     * @param {CheckoutFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const checkout = await prisma.checkout.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: CheckoutFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Checkout.
     * @param {CheckoutAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const checkout = await prisma.checkout.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: CheckoutAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface CheckoutFieldRefs {
    ...
    readonly name: FieldRef<"Checkout", 'String'>
    readonly phone: FieldRef<"Checkout", 'String'>
    readonly email: FieldRef<"Checkout", 'String'>
    readonly address: FieldRef<"Checkout", 'String'>
    readonly districts: FieldRef<"Checkout", 'String'>
    readonly area: FieldRef<"Checkout", 'String'>
    readonly postalcode: FieldRef<"Checkout", 'String'>
    readonly products: FieldRef<"Checkout", 'Json'>
    readonly Payment: FieldRef<"Checkout", 'String'>
   ...
   * Checkout findRaw
   */
  export type CheckoutFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * Checkout aggregateRaw
   */
  export type CheckoutAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type CheckoutWhereInput = {
    ...
    name?: StringFilter<"Checkout"> | string
    phone?: StringFilter<"Checkout"> | string
    email?: StringFilter<"Checkout"> | string
    address?: StringFilter<"Checkout"> | string
    districts?: StringFilter<"Checkout"> | string
    area?: StringFilter<"Checkout"> | string
    postalcode?: StringFilter<"Checkout"> | string
    products?: JsonFilter<"Checkout">
    Payment?: StringFilter<"Checkout"> | string
  ...
  export type CheckoutScalarWhereWithAggregatesInput = {
    ...
    name?: StringWithAggregatesFilter<"Checkout"> | string
    phone?: StringWithAggregatesFilter<"Checkout"> | string
    email?: StringWithAggregatesFilter<"Checkout"> | string
    address?: StringWithAggregatesFilter<"Checkout"> | string
    districts?: StringWithAggregatesFilter<"Checkout"> | string
    area?: StringWithAggregatesFilter<"Checkout"> | string
    postalcode?: StringWithAggregatesFilter<"Checkout"> | string
    products?: JsonWithAggregatesFilter<"Checkout">
    Payment?: StringWithAggregatesFilter<"Checkout"> | string
  ...
  export type ProductUpdateInput = {
    ...
    size?: InputJsonValue | InputJsonValue
  }
